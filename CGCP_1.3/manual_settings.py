...
path = r"C:\Users\annawi\Desktop\Projects\Propene oxidation\Experiments\Calibration\new GC calibration\20190520 new calibration\GC_RAMP_PROPENE-method\1%H2 in Ar" #\1%CO in Ar or 1%H2 in Ar

# path = r"C:\Users\annawi\Desktop\Projects\Propene oxidation\Experiments\Calibration\new GC calibration\20190520 new calibration\GC_RAMP_SHORT_CO2-method" # \COO in 1%CO in Ar or HER in Ar
...
output_path = r"C:\Users\annawi\Desktop\Projects\Propene oxidation\Experiments\Calibration\new GC calibration\20190520 new calibration\analysis\CO and H2 in Ar" #CO and H2 in Ar, CO2 from CO, HER for volume
save_plots = True
...
fit_info[TCD_key]['CO_TCD']['start'] = [7.77]
fit_info[TCD_key]['CO_TCD']['end'] =  [8.07]#[4]
